	...
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<img src="../../assets/img/logo.png" alt="navbar brand" class="navbar-brand" width="120" height="75" >
				</a>
				...
				<div class="page-inner mt--5">
								...
								<div class="card-body">
									...
									<div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
										<div class="px-2 pb-2 pb-md-0 text-center">
											...
											<h6 class="fw-bold mt-3 mb-0">Beneficiarios</h6>
											<?php
										...
										<div class="px-2 pb-2 pb-md-0 text-center">
											...
											<h6 class="fw-bold mt-3 mb-0">profesionales</h6>
											<?php
											  require_once "../config/conexion1.php";
					...
					<div class="row">
						<div class="col-md-4">
							<div class="card">
								<div class="card-body">
									<div class="card-title fw-mediumbold">Nuevos Beneficiarios</div>
									<?php
function connect(){
...
<!-- POR ACA COMENTO O BAJO DATOS DE MYSQL PARA VISUALIZARLO CON LAS CONEXIONES--------  -->
										...
										<div class="item-list">
											...
											<div class="info-user ml-3">
												...
												<div class="status">Beneficiarios</div>
											</div>
						...
						<div class="col-md-4">
							<div class="card">
								<div class="card-body">
									<div class="card-title fw-mediumbold">Nuevos profesionales</div>
									<?php
